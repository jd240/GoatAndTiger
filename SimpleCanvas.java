...
public class SimpleCanvas
{
   ...
   /**
    ...
    public void drawGoat(int x, int y, int w, int h) {
        Image img = new ImageIcon("prey.png").getImage();
        graphic.drawImage(img, x, y, w, h, null);
        if (autoRepaint) canvas.repaint();
    }
    public void drawTiger(int x, int y, int w, int h) {
        Image img = new ImageIcon("predator.png").getImage();
        graphic.drawImage(img, x, y, w, h, null);
        if (autoRepaint) canvas.repaint();
    }
}
